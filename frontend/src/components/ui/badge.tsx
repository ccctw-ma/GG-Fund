...
export function Badge({ className, tone = 'slate', ...props }: React.HTMLAttributes<HTMLSpanElement> & { tone?: 'slate' | 'red' | 'green' | 'blue' | 'amber' | 'violet' }) {
  const tones = {
    ...
    amber: 'bg-[var(--gold)]/14 text-[var(--gold-soft)] ring-1 ring-[var(--gold)]/22',
    violet: 'bg-[#a78bfa]/14 text-[#c4b5fd] ring-1 ring-[#a78bfa]/22',
  };
