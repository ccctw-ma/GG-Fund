...
describe('dashboard components', () => {
  ...
  it('renders market and fund sections with selected quote state', async () => {
    ...
    expect(search.container.textContent).not.toContain('年化收益');
    expect(search.container.textContent).not.toContain('夏普');
    expect(search.container.textContent).not.toContain('波动率');
    expect(search.container.textContent).not.toContain('相对基准');
    expect(search.container.textContent).not.toContain('超额收益');
