...
export const researchCatalog = {
  assetNavigation: [
    ...
    { title: '养基账本', description: '多平台持仓、今日估算收益、盈亏报告、风险诊断、定投和止盈提醒。', status: 'live', sourceHint: '浏览器本地账本 + 实时行情计算', icon: WalletCards },
  ...
  toolGroups: [
    ...
    },
    {
      ...
      capabilities: [
        ...
        { title: '多平台账本', description: '支持支付宝、理财通、天天基金、雪球等来源的文本识别式导入。', status: 'live' },
        { title: '盈亏周报/月报', description: '基于当前持仓自动生成今日估算收益、累计盈亏和贡献拆解。', status: 'live' },
        { title: '风险与止盈提醒', description: '检查集中度、净值缺失、7 天赎回、目标权重偏离和教育型止盈线。', status: 'live' },
        { title: '自选观察', description: '关注基金但不计入持仓，适合买前跟踪。', status: 'live' },
        { title: '定投计划', description: '按当前投入成本和盈亏状态生成教育型分批行动路线。', status: 'live' },
        { title: '截图 OCR 同步', description: '真实图片 OCR 和平台授权同步仍需后续接入，不伪造识别结果。', status: 'roadmap' },
      ],
    },
    {
      title: '资讯、社区与观点流',
