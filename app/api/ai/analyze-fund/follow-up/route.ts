...
import { buildAnalyzeFundFollowUpResponse, normalizeAnalyzeFundFollowUpRequest } from '../../../../../features/ai/service';
...
export async function POST(request: Request) {
  try {
    const body = normalizeAnalyzeFundFollowUpRequest(await readJson(request));
    return Response.json(
      await buildAnalyzeFundFollowUpResponse(body, {
